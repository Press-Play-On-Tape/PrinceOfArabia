...
constexpr uint16_t FX_DATA_PAGE  = 0xfb0a;
constexpr uint24_t FX_DATA_BYTES = 324915;
...
namespace Levels
{
  ...
  constexpr uint24_t Level4_Items = 0x002786;
  constexpr uint24_t Level5_FG = 0x002847;
  constexpr uint24_t Level5_BG = 0x002D8D;
  constexpr uint24_t level5_Data = 0x0032D3;
  constexpr uint24_t Level5_Items = 0x0032FD;
  constexpr uint24_t level_FG = 0x003363;
  constexpr uint24_t Level_BG = 0x003375;
  constexpr uint24_t level_Data = 0x003387;
  constexpr uint24_t Level_Items = 0x003399;
}

namespace CutScene
{
  constexpr uint24_t Scene1 = 0x0033AB;
  constexpr uint24_t Scene9 = 0x00378F;
}

namespace Sounds
{
  constexpr uint24_t Dead = 0x00398F;
  constexpr uint24_t Grab1 = 0x0039AD;
  constexpr uint24_t Grab2 = 0x0039D7;
  constexpr uint24_t Grab3 = 0x003A01;
  constexpr uint24_t Grab4 = 0x003A3B;
  constexpr uint24_t Seque = 0x003A91;
  constexpr uint24_t Tada = 0x003B0B;
  constexpr uint24_t Theme = 0x003B29;
  constexpr uint24_t Triumph = 0x003CF7;
}

namespace Images
{
  constexpr uint24_t PPOT = 0x003D15;
  constexpr uint16_t PPOT_WIDTH  = 65;
  constexpr uint16_t PPOTHEIGHT  = 31;
  constexpr uint8_t  PPOT_FRAMES = 4;

  constexpr uint24_t Title_PoP = 0x004129;
  constexpr uint16_t Title_PoP_width  = 128;
  constexpr uint16_t Title_PoP_height = 33;

  constexpr uint24_t Title_Main = 0x00462D;
  constexpr uint16_t Title_Main_width  = 128;
  constexpr uint16_t Title_Main_height = 88;

  constexpr uint24_t Title_Cursor = 0x004BB1;
  constexpr uint16_t Title_Cursor_width  = 5;
  constexpr uint16_t Title_Cursor_height = 5;

  constexpr uint24_t Title_Credits = 0x004BBA;
  constexpr uint16_t Title_Credits_width  = 73;
  constexpr uint16_t Title_Credits_height = 251;

  constexpr uint24_t TimeRemaining = 0x0054DE;
  constexpr uint16_t TimeRemainingWidth  = 81;
  constexpr uint16_t TimeRemainingHeight = 15;

  constexpr uint24_t LevelNumber = 0x005626;
  constexpr uint16_t LevelNumberWidth  = 81;
  constexpr uint16_t LevelNumberHeight = 15;

  constexpr uint24_t GameOver = 0x00576E;
  constexpr uint16_t GameOverWidth  = 49;
  constexpr uint16_t GameOverHeight = 15;

  constexpr uint24_t PressA = 0x005836;
  constexpr uint16_t PressAWidth  = 79;
  constexpr uint16_t PressAHeight = 15;

  constexpr uint24_t IntroGame_1A = 0x005976;
  constexpr uint16_t IntroGame_1A_width  = 118;
  constexpr uint16_t IntroGame_1A_height = 96;

  constexpr uint24_t IntroGame_1B = 0x005F02;
  constexpr uint16_t IntroGame_1B_width  = 123;
  constexpr uint16_t IntroGame_1B_height = 96;

  constexpr uint24_t IntroGame_9 = 0x0064CA;
  constexpr uint16_t IntroGame_9_width  = 123;
  constexpr uint16_t IntroGame_9_height = 160;

  constexpr uint24_t Chambers_BG = 0x006E6A;
  constexpr uint16_t Chambers_BG_width  = 128;
  constexpr uint16_t Chambers_BG_height = 64;

  constexpr uint24_t Chambers_FG = 0x00726E;
  constexpr uint16_t Chambers_FG_width  = 128;
  constexpr uint16_t Chambers_FG_height = 64;

  constexpr uint24_t Credits_BG = 0x007A72;
  constexpr uint16_t Credits_BG_width  = 128;
  constexpr uint16_t Credits_BG_height = 9;

  constexpr uint24_t Numbers_Upright = 0x007B76;
  ...
  constexpr uint24_t Potions_Large = 0x008E62;
  ...
  constexpr uint24_t Potions_Poison = 0x008E96;
  ...
  constexpr uint24_t FloorButtons_0and1 = 0x0092F2;
  ...
  constexpr uint24_t FloorButtons_2 = 0x009596;
  ...
  constexpr uint24_t Spikes_BG_Full = 0x00993C;
  ...
  constexpr uint24_t Spikes_FG_Half = 0x009B7A;
  ...
  constexpr uint24_t Spikes_BG_Half = 0x009CC8;
  ...
  constexpr uint24_t Mirror_Right = 0x03B5E8;
...
namespace Constants
{
  constexpr uint24_t VertAdjustments = 0x04F254;
  constexpr uint24_t Prince_ImageDetails = 0x04F2EA;
}
