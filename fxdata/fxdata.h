...
constexpr uint16_t FX_DATA_PAGE  = 0xf15f;
constexpr uint24_t FX_DATA_BYTES = 954610;
...
namespace Constants
{
  ...
  constexpr uint24_t Stance_XYOffsetsFX = 0x0C3D3B;
}

namespace Constants
{
  constexpr uint24_t VertAdjustments = 0x0C436F;
  constexpr uint24_t Prince_ImageDetails = 0x0C4405;
}

constexpr uint24_t splashScreen_Frame = 0x0C465A;
constexpr uint24_t Title_Main_Game_PoP_Frame_NC = 0x0C467E;
constexpr uint24_t Title_Main_Game_PoA_Frame_NC = 0x0C4690;
constexpr uint24_t Title_Main_Game_PoP_Frame_NCH = 0x0C46A2;
constexpr uint24_t Title_Main_Game_PoA_Frame_NCH = 0x0C46B4;
constexpr uint24_t Title_Main_Game_PoP_Frame_NRC = 0x0C46C6;
constexpr uint24_t Title_Main_Game_PoA_Frame_NRC = 0x0C46D8;
constexpr uint24_t Title_Main_Game_PoP_Frame_NRCH = 0x0C46EA;
constexpr uint24_t Title_Main_Game_PoA_Frame_NRCH = 0x0C46FC;
constexpr uint24_t Title_High_PoP_Frame = 0x0C470E;
constexpr uint24_t Title_High_PoA_Frame = 0x0C47B0;
constexpr uint24_t Title_Cursor_XPos = 0x0C4852;
constexpr uint24_t Invaders_HUD_frame = 0x0C4862;
constexpr uint24_t Title_Intro_PoP_Frame_NC = 0x0C4874;
constexpr uint24_t Title_Intro_Last_PoP_Frame_NC = 0x0C4CF4;
constexpr uint24_t Title_Intro_PoP_Frame_NCH = 0x0C4D06;
constexpr uint24_t Title_Intro_Last_PoP_Frame_NCH = 0x0C5186;
constexpr uint24_t Title_Intro_PoP_Frame_NRC = 0x0C5198;
constexpr uint24_t Title_Intro_Last_PoP_Frame_NRC = 0x0C5618;
constexpr uint24_t Title_Intro_PoP_Frame_NRCH = 0x0C562A;
constexpr uint24_t Title_Intro_Last_PoP_Frame_NRCH = 0x0C5AAA;
constexpr uint24_t Title_Intro_PoA_Frame_NC = 0x0C5ABC;
constexpr uint24_t Title_Intro_Last_PoA_Frame_NC = 0x0C5F3C;
constexpr uint24_t Title_Intro_PoA_Frame_NCH = 0x0C5F4E;
constexpr uint24_t Title_Intro_Last_PoA_Frame_NCH = 0x0C63CE;
constexpr uint24_t Title_Intro_PoA_Frame_NRC = 0x0C63E0;
constexpr uint24_t Title_Intro_Last_PoA_Frame_NRC = 0x0C6860;
constexpr uint24_t Title_Intro_PoA_Frame_NRCH = 0x0C6872;
constexpr uint24_t Title_Intro_Last_PoA_Frame_NRCH = 0x0C6CF2;
constexpr uint24_t Title_Main_PoP_Frame_NC = 0x0C6D04;
constexpr uint24_t Title_Main_Last_PoP_Frame_NC = 0x0C6E90;
constexpr uint24_t Title_Main_PoP_Frame_NCH = 0x0C6EA2;
constexpr uint24_t Title_Main_Last_PoP_Frame_NCH = 0x0C702E;
constexpr uint24_t Title_Main_PoP_Frame_NRC = 0x0C7040;
constexpr uint24_t Title_Main_Last_PoP_Frame_NRC = 0x0C71CC;
constexpr uint24_t Title_Main_PoP_Frame_NRCH = 0x0C71DE;
constexpr uint24_t Title_Main_Last_PoP_Frame_NRCH = 0x0C736A;
constexpr uint24_t Title_Main_PoA_Frame_NC = 0x0C737C;
constexpr uint24_t Title_Main_Last_PoA_Frame_NC = 0x0C7508;
constexpr uint24_t Title_Main_PoA_Frame_NCH = 0x0C751A;
constexpr uint24_t Title_Main_Last_PoA_Frame_NCH = 0x0C76A6;
constexpr uint24_t Title_Main_PoA_Frame_NRC = 0x0C76B8;
constexpr uint24_t Title_Main_Last_PoA_Frame_NRC = 0x0C7844;
constexpr uint24_t Title_Main_PoA_Frame_NRCH = 0x0C7856;
constexpr uint24_t Title_Main_Last_PoA_Frame_NRCH = 0x0C79E2;
constexpr uint24_t Title_Credits_PoP_Frame = 0x0C79F4;
constexpr uint24_t Title_Credits_PoA_Frame = 0x0CAB6B;
constexpr uint24_t Title_TimeOut_PoP_Frame = 0x0CDCE2;
constexpr uint24_t Title_TimeOut_PoA_Frame = 0x0D0964;
constexpr uint24_t Title_IntroGame_1A_Frame = 0x0D35E6;
constexpr uint24_t Title_CutScene_1_Frame = 0x0D3BBC;
constexpr uint24_t Title_IntroGame_1B_Frame = 0x0D70C9;
constexpr uint24_t Title_CutScene_2_Frame = 0x0D769F;
constexpr uint24_t Title_CutScene_2B_Frame = 0x0D8ADF;
constexpr uint24_t Title_CutScene_3_Frame = 0x0DBA1F;
constexpr uint24_t Title_CutScene_4_Frame = 0x0DCE5F;
constexpr uint24_t Title_CutScene_5_Frame = 0x0DD87F;
constexpr uint24_t Title_CutScene_6_Frame = 0x0DEE03;
constexpr uint24_t Title_CutScene_7_Frame = 0x0E18CC;
constexpr uint24_t Title_CutScene_End_Frame = 0x0E64F2;
constexpr uint24_t Title_IntroGame_End_PoP_Frame = 0x0E7F62;
constexpr uint24_t Title_IntroGame_End_PoA_Frame = 0x0E87AE;
constexpr uint24_t TitleFrameIndexTable = 0x0E8FFA;
