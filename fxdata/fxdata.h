...
constexpr uint16_t FX_DATA_PAGE  = 0xf50d;
constexpr uint24_t FX_DATA_BYTES = 713377;
...
namespace Levels
{
  ...
  constexpr uint24_t Level20_RunningJumps_BG = 0x00937B;
  constexpr uint24_t Level20_RunningJumps_Data = 0x00953D;
  constexpr uint24_t Level20_RunningJumps_Items = 0x009546;
  constexpr uint24_t Level21_RunningJumps_FG = 0x009547;
  constexpr uint24_t Level21_RunningJumps_BG = 0x009709;
  constexpr uint24_t Level21_RunningJumps_Data = 0x0098CB;
  constexpr uint24_t Level21_RunningJumps_Items = 0x0098D4;
  constexpr uint24_t Level22_RunningJumps_FG = 0x0098D5;
  constexpr uint24_t Level22_RunningJumps_BG = 0x009A97;
  constexpr uint24_t Level22_RunningJumps_Data = 0x009C59;
  constexpr uint24_t Level22_RunningJumps_Items = 0x009C62;
  constexpr uint24_t Level23_RunningJumps_FG = 0x009C63;
  constexpr uint24_t Level23_RunningJumps_BG = 0x009E25;
  constexpr uint24_t Level23_RunningJumps_Data = 0x009FE7;
  constexpr uint24_t Level23_RunningJumps_Items = 0x009FF0;
  constexpr uint24_t Level24_RunningJumps_FG = 0x009FF1;
  constexpr uint24_t Level24_RunningJumps_BG = 0x00A1B3;
  constexpr uint24_t Level24_RunningJumps_Data = 0x00A375;
  constexpr uint24_t Level24_RunningJumps_Items = 0x00A37E;
  constexpr uint24_t level_FG = 0x00A37F;
  constexpr uint24_t Level_BG = 0x00A3CA;
  constexpr uint24_t level_Data = 0x00A415;
  constexpr uint24_t Level_Items = 0x00A460;
}

namespace Sounds
{
  constexpr uint24_t Dead = 0x00A4AB;
  constexpr uint24_t Grab1 = 0x00A4C9;
  constexpr uint24_t Grab2 = 0x00A4F3;
  constexpr uint24_t Grab3 = 0x00A51D;
  constexpr uint24_t Grab4 = 0x00A557;
  constexpr uint24_t Seque = 0x00A5AD;
  constexpr uint24_t Tada = 0x00A627;
  constexpr uint24_t Theme = 0x00A645;
  constexpr uint24_t Triumph = 0x00A813;
  constexpr uint24_t Victory = 0x00A831;
  constexpr uint24_t Ending = 0x00A8A3;
  constexpr uint24_t OutOfTime = 0x00AB21;
  constexpr uint24_t GateGoingDown = 0x00AB67;
  constexpr uint24_t GateGoingUp = 0x00ABA5;
  constexpr uint24_t ChopChop = 0x00ABE3;
  constexpr uint24_t Thump = 0x00ABF5;
  constexpr uint24_t Strike = 0x00AC07;
  constexpr uint24_t Invader_Wave_Start = 0x00AC15;
  constexpr uint24_t Invader_Wave_Success = 0x00AC43;
  constexpr uint24_t Invader_End_of_Game = 0x00ACE9;
  constexpr uint24_t Invader_Player_Fires_Bullet = 0x00AD2F;
  constexpr uint24_t Invader_Enemy_Fires_Bullet = 0x00AD3D;
  constexpr uint24_t Invader_Player_Explosion = 0x00AD4B;
  constexpr uint24_t Invader_Enemy_Explosion = 0x00AD95;
  constexpr uint24_t Invader_Hit_Barrier = 0x00ADDF;
}

namespace Images
{
  constexpr uint24_t PPOT = 0x00ADE9;
  constexpr uint16_t PPOT_WIDTH  = 65;
  constexpr uint16_t PPOTHEIGHT  = 31;
  constexpr uint8_t  PPOT_FRAMES = 4;

  constexpr uint24_t Title_PoP = 0x00B1FD;
  constexpr uint16_t Title_PoP_width  = 128;
  constexpr uint16_t Title_PoP_height = 33;

  constexpr uint24_t Title_Main_NoHigh = 0x00B701;
  constexpr uint16_t Title_Main_NoHigh_width  = 128;
  constexpr uint16_t Title_Main_NoHigh_height = 88;

  constexpr uint24_t Title_Main_WithHigh = 0x00BC85;
  constexpr uint16_t Title_Main_WithHigh_width  = 128;
  constexpr uint16_t Title_Main_WithHigh_height = 88;

  constexpr uint24_t Title_Cursor = 0x00C209;
  constexpr uint16_t Title_Cursor_width  = 5;
  constexpr uint16_t Title_Cursor_height = 5;

  constexpr uint24_t Title_Credits = 0x00C212;
  constexpr uint16_t Title_Credits_width  = 73;
  constexpr uint16_t Title_Credits_height = 136;

  constexpr uint24_t TimeRemaining = 0x00C6EF;
  constexpr uint16_t TimeRemainingWidth  = 81;
  constexpr uint16_t TimeRemainingHeight = 15;

  constexpr uint24_t LevelNumber = 0x00C837;
  constexpr uint16_t LevelNumberWidth  = 81;
  constexpr uint16_t LevelNumberHeight = 15;

  constexpr uint24_t GameOver = 0x00C97F;
  constexpr uint16_t GameOverWidth  = 49;
  constexpr uint16_t GameOverHeight = 15;

  constexpr uint24_t PressA = 0x00CA47;
  constexpr uint16_t PressAWidth  = 79;
  constexpr uint16_t PressAHeight = 15;

  constexpr uint24_t TimeOut = 0x00CB87;
  constexpr uint16_t TimeOutWidth  = 86;
  constexpr uint16_t TimeOutHeight = 114;

  constexpr uint24_t IntroGame_1A = 0x00D095;
  constexpr uint16_t IntroGame_1A_width  = 118;
  constexpr uint16_t IntroGame_1A_height = 96;

  constexpr uint24_t IntroGame_1B = 0x00D621;
  constexpr uint16_t IntroGame_1B_width  = 123;
  constexpr uint16_t IntroGame_1B_height = 96;

  constexpr uint24_t IntroGame_9 = 0x00DBE9;
  constexpr uint16_t IntroGame_9_width  = 123;
  constexpr uint16_t IntroGame_9_height = 160;

  constexpr uint24_t Chambers_BG = 0x00E589;
  constexpr uint16_t Chambers_BG_width  = 128;
  constexpr uint16_t Chambers_BG_height = 64;

  constexpr uint24_t Chambers_BG_01 = 0x00E98D;
  constexpr uint16_t Chambers_BG_01_width  = 128;
  constexpr uint16_t Chambers_BG_01_height = 55;

  constexpr uint24_t Chambers_BG_02 = 0x00ED11;
  constexpr uint16_t Chambers_BG_02_width  = 128;
  constexpr uint16_t Chambers_BG_02_height = 9;

  constexpr uint24_t Chambers_FG = 0x00EE15;
  constexpr uint16_t Chambers_FG_width  = 128;
  constexpr uint16_t Chambers_FG_height = 64;

  constexpr uint24_t Credits_BG = 0x00F619;
  constexpr uint16_t Credits_BG_width  = 128;
  constexpr uint16_t Credits_BG_height = 9;

  constexpr uint24_t Eeek = 0x00F71D;
  constexpr uint16_t EeekWidth  = 43;
  constexpr uint16_t EeekHeight = 19;

  constexpr uint24_t LevelRect = 0x00F823;
  constexpr uint16_t LevelRectWidth  = 16;
  constexpr uint16_t LevelRectHeight = 8;

  constexpr uint24_t Mouse = 0x00F837;
  constexpr uint16_t MouseWidth  = 16;
  constexpr uint16_t MouseHeight = 16;
  constexpr uint8_t  MouseFrames = 3;

  constexpr uint24_t HourGlasses = 0x00F8FB;
  constexpr uint16_t HourGlassesWidth  = 19;
  constexpr uint16_t HourGlassesHeight = 23;
  constexpr uint8_t  HourGlassesFrames = 6;

  constexpr uint24_t Menu = 0x00FBAB;
  constexpr uint16_t MenuWidth  = 42;
  constexpr uint16_t MenuHeight = 64;
  constexpr uint8_t  MenuFrames = 3;

  constexpr uint24_t Sword_Cursor = 0x00FF9F;
  constexpr uint16_t Sword_Cursor_width  = 8;
  constexpr uint16_t Sword_Cursor_height = 10;

  constexpr uint24_t HUD_Backgrounds = 0x00FFB3;
  ...
  constexpr uint24_t Numbers_Upright = 0x010077;
  ...
  constexpr uint24_t Numbers_Small = 0x010F0B;
  ...
  constexpr uint24_t Potions_Large = 0x011CDC;
  ...
  constexpr uint24_t Potions_Poison = 0x011D10;
  ...
  constexpr uint24_t Potions_Float = 0x011DA4;
  ...
  constexpr uint24_t FloorButtons_0and1 = 0x0121C3;
  ...
  constexpr uint24_t FloorButtons_2 = 0x012467;
  ...
  constexpr uint24_t Spikes_BG_Full = 0x01280D;
  ...
  constexpr uint24_t Spikes_FG_Half = 0x012A4B;
  ...
  constexpr uint24_t Spikes_BG_Half = 0x012B99;
  ...
  constexpr uint24_t Mirror_Right = 0x044917;
...
namespace Constants
{
  constexpr uint24_t StanceToImageXRefFX = 0x094D7C;
  constexpr uint24_t Stance_XYOffsetsFX = 0x09504B;
  constexpr uint24_t VertAdjustments = 0x0955E7;
  constexpr uint24_t Prince_ImageDetails = 0x09567D;
}

constexpr uint24_t splashScreen_Frame = 0x0958C6;
constexpr uint24_t Title_Intro_Frame_NoHigh = 0x0958EA;
constexpr uint24_t Title_Intro_Last_Frame_NoHigh = 0x095D6A;
constexpr uint24_t Title_Intro_Frame_WithHigh = 0x095D7C;
constexpr uint24_t Title_Intro_Last_Frame_WithHigh = 0x0961FC;
constexpr uint24_t Title_Main_Frame_NoHigh = 0x09620E;
constexpr uint24_t Title_Main_Last_Frame_NoFrame = 0x09639A;
constexpr uint24_t Title_Main_Frame_WithHigh = 0x0963AC;
constexpr uint24_t Title_Main_Last_Frame_WithHigh = 0x096538;
constexpr uint24_t Title_Main_Game_Frame_NoHigh = 0x09654A;
constexpr uint24_t Title_Main_Game_Frame_WithHigh = 0x096565;
constexpr uint24_t Title_Main_Credits_Frame_NoHigh = 0x096580;
constexpr uint24_t Title_Main_Credits_Frame_WithHigh = 0x09659B;
constexpr uint24_t Title_Main_High_Frame_WithHigh = 0x0965B6;
constexpr uint24_t Title_Credits_Frame = 0x0965D1;
constexpr uint24_t Title_TimeOut_Frame = 0x099748;
constexpr uint24_t Title_High_Frame = 0x09C3CA;
constexpr uint24_t Title_IntroGame_1A_Frame = 0x09C451;
constexpr uint24_t Title_CutScene_1_Frame = 0x09CA27;
constexpr uint24_t Title_IntroGame_1B_Frame = 0x09FF34;
constexpr uint24_t Title_CutScene_2_Frame = 0x0A050A;
constexpr uint24_t Title_CutScene_3_Frame = 0x0A194A;
constexpr uint24_t Title_CutScene_4_Frame = 0x0A2D8A;
constexpr uint24_t Title_CutScene_5_Frame = 0x0A37AA;
constexpr uint24_t Title_CutScene_6_Frame = 0x0A4D2E;
constexpr uint24_t Title_CutScene_7_Frame = 0x0A77F7;
constexpr uint24_t Title_CutScene_End_Frame = 0x0ABFE5;
constexpr uint24_t Title_IntroGame_End_Frame = 0x0ADA55;
