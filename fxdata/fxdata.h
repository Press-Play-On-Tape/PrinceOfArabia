...
constexpr uint24_t FX_DATA_BYTES = 621967;
...
constexpr uint24_t Title_High_Frame = 0x093BF5;
constexpr uint24_t Title_IntroGame_1A_Frame = 0x093C7C;
constexpr uint24_t Title_CutScene_1_Frame = 0x094252;
constexpr uint24_t Title_IntroGame_1B_Frame = 0x09775F;
constexpr uint24_t Chambers_BG_frame = 0x097D35;
constexpr uint24_t Chambers_FG_frame = 0x097D86;
