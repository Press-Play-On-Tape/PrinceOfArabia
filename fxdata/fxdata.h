...
constexpr uint16_t FX_DATA_PAGE  = 0xf52e;
constexpr uint24_t FX_DATA_BYTES = 704947;
...
namespace Levels
{
  ...
  constexpr uint24_t level_FG = 0x008381;
  constexpr uint24_t Level_BG = 0x0083B1;
  constexpr uint24_t level_Data = 0x0083E1;
  constexpr uint24_t Level_Items = 0x008411;
}

namespace Sounds
{
  constexpr uint24_t Dead = 0x008441;
  constexpr uint24_t Grab1 = 0x00845F;
  constexpr uint24_t Grab2 = 0x008489;
  constexpr uint24_t Grab3 = 0x0084B3;
  constexpr uint24_t Grab4 = 0x0084ED;
  constexpr uint24_t Seque = 0x008543;
  constexpr uint24_t Tada = 0x0085BD;
  constexpr uint24_t Theme = 0x0085DB;
  constexpr uint24_t Triumph = 0x0087A9;
  constexpr uint24_t Victory = 0x0087C7;
  constexpr uint24_t Ending = 0x008839;
  constexpr uint24_t OutOfTime = 0x008AB7;
  constexpr uint24_t GateGoingDown = 0x008AFD;
  constexpr uint24_t GateGoingUp = 0x008B3B;
  constexpr uint24_t ChopChop = 0x008B79;
  constexpr uint24_t Thump = 0x008B8B;
  constexpr uint24_t Strike = 0x008B9D;
  constexpr uint24_t Invader_Wave_Start = 0x008BAB;
  constexpr uint24_t Invader_Wave_Success = 0x008BD9;
  constexpr uint24_t Invader_End_of_Game = 0x008C7F;
  constexpr uint24_t Invader_Player_Fires_Bullet = 0x008CC5;
  constexpr uint24_t Invader_Enemy_Fires_Bullet = 0x008CD3;
  constexpr uint24_t Invader_Player_Explosion = 0x008CE1;
  constexpr uint24_t Invader_Enemy_Explosion = 0x008D2B;
  constexpr uint24_t Invader_Hit_Barrier = 0x008D75;
}

namespace Images
{
  constexpr uint24_t PPOT = 0x008D7F;
  constexpr uint16_t PPOT_WIDTH  = 65;
  constexpr uint16_t PPOTHEIGHT  = 31;
  constexpr uint8_t  PPOT_FRAMES = 4;

  constexpr uint24_t Title_PoP = 0x009193;
  constexpr uint16_t Title_PoP_width  = 128;
  constexpr uint16_t Title_PoP_height = 33;

  constexpr uint24_t Title_Main_NoHigh = 0x009697;
  constexpr uint16_t Title_Main_NoHigh_width  = 128;
  constexpr uint16_t Title_Main_NoHigh_height = 88;

  constexpr uint24_t Title_Main_WithHigh = 0x009C1B;
  constexpr uint16_t Title_Main_WithHigh_width  = 128;
  constexpr uint16_t Title_Main_WithHigh_height = 88;

  constexpr uint24_t Title_Cursor = 0x00A19F;
  constexpr uint16_t Title_Cursor_width  = 5;
  constexpr uint16_t Title_Cursor_height = 5;

  constexpr uint24_t Title_Credits = 0x00A1A8;
  constexpr uint16_t Title_Credits_width  = 73;
  constexpr uint16_t Title_Credits_height = 136;

  constexpr uint24_t TimeRemaining = 0x00A685;
  constexpr uint16_t TimeRemainingWidth  = 81;
  constexpr uint16_t TimeRemainingHeight = 15;

  constexpr uint24_t LevelNumber = 0x00A7CD;
  constexpr uint16_t LevelNumberWidth  = 81;
  constexpr uint16_t LevelNumberHeight = 15;

  constexpr uint24_t GameOver = 0x00A915;
  constexpr uint16_t GameOverWidth  = 49;
  constexpr uint16_t GameOverHeight = 15;

  constexpr uint24_t PressA = 0x00A9DD;
  constexpr uint16_t PressAWidth  = 79;
  constexpr uint16_t PressAHeight = 15;

  constexpr uint24_t TimeOut = 0x00AB1D;
  constexpr uint16_t TimeOutWidth  = 86;
  constexpr uint16_t TimeOutHeight = 114;

  constexpr uint24_t IntroGame_1A = 0x00B02B;
  constexpr uint16_t IntroGame_1A_width  = 118;
  constexpr uint16_t IntroGame_1A_height = 96;

  constexpr uint24_t IntroGame_1B = 0x00B5B7;
  constexpr uint16_t IntroGame_1B_width  = 123;
  constexpr uint16_t IntroGame_1B_height = 96;

  constexpr uint24_t IntroGame_9 = 0x00BB7F;
  constexpr uint16_t IntroGame_9_width  = 123;
  constexpr uint16_t IntroGame_9_height = 160;

  constexpr uint24_t Chambers_BG = 0x00C51F;
  constexpr uint16_t Chambers_BG_width  = 128;
  constexpr uint16_t Chambers_BG_height = 64;

  constexpr uint24_t Chambers_BG_01 = 0x00C923;
  constexpr uint16_t Chambers_BG_01_width  = 128;
  constexpr uint16_t Chambers_BG_01_height = 55;

  constexpr uint24_t Chambers_BG_02 = 0x00CCA7;
  constexpr uint16_t Chambers_BG_02_width  = 128;
  constexpr uint16_t Chambers_BG_02_height = 9;

  constexpr uint24_t Chambers_FG = 0x00CDAB;
  constexpr uint16_t Chambers_FG_width  = 128;
  constexpr uint16_t Chambers_FG_height = 64;

  constexpr uint24_t Credits_BG = 0x00D5AF;
  constexpr uint16_t Credits_BG_width  = 128;
  constexpr uint16_t Credits_BG_height = 9;

  constexpr uint24_t Eeek = 0x00D6B3;
  constexpr uint16_t EeekWidth  = 43;
  constexpr uint16_t EeekHeight = 19;

  constexpr uint24_t LevelRect = 0x00D7B9;
  constexpr uint16_t LevelRectWidth  = 16;
  constexpr uint16_t LevelRectHeight = 8;

  constexpr uint24_t Mouse = 0x00D7CD;
  constexpr uint16_t MouseWidth  = 16;
  constexpr uint16_t MouseHeight = 16;
  constexpr uint8_t  MouseFrames = 3;

  constexpr uint24_t HourGlasses = 0x00D891;
  constexpr uint16_t HourGlassesWidth  = 19;
  constexpr uint16_t HourGlassesHeight = 23;
  constexpr uint8_t  HourGlassesFrames = 6;

  constexpr uint24_t Menu = 0x00DB41;
  constexpr uint16_t MenuWidth  = 42;
  constexpr uint16_t MenuHeight = 64;
  constexpr uint8_t  MenuFrames = 3;

  constexpr uint24_t Sword_Cursor = 0x00DF35;
  constexpr uint16_t Sword_Cursor_width  = 8;
  constexpr uint16_t Sword_Cursor_height = 10;

  constexpr uint24_t HUD_Backgrounds = 0x00DF49;
  ...
  constexpr uint24_t Numbers_Upright = 0x00E00D;
  ...
  constexpr uint24_t Numbers_Small = 0x00EEA1;
  ...
  constexpr uint24_t Potions_Large = 0x00FC72;
  ...
  constexpr uint24_t Potions_Poison = 0x00FCA6;
  ...
  constexpr uint24_t Potions_Float = 0x00FD3A;
  ...
  constexpr uint24_t FloorButtons_0and1 = 0x010159;
  ...
  constexpr uint24_t FloorButtons_2 = 0x0103FD;
  ...
  constexpr uint24_t Spikes_BG_Full = 0x0107A3;
  ...
  constexpr uint24_t Spikes_FG_Half = 0x0109E1;
  ...
  constexpr uint24_t Spikes_BG_Half = 0x010B2F;
  ...
  constexpr uint24_t Mirror_Right = 0x0428AD;
...
namespace Constants
{
  constexpr uint24_t StanceToImageXRefFX = 0x092D12;
  constexpr uint24_t Stance_XYOffsetsFX = 0x092FB5;
  constexpr uint24_t VertAdjustments = 0x0934F9;
  constexpr uint24_t Prince_ImageDetails = 0x09358F;
}

constexpr uint24_t splashScreen_Frame = 0x0937D8;
constexpr uint24_t Title_Intro_Frame_NoHigh = 0x0937FC;
constexpr uint24_t Title_Intro_Last_Frame_NoHigh = 0x093C7C;
constexpr uint24_t Title_Intro_Frame_WithHigh = 0x093C8E;
constexpr uint24_t Title_Intro_Last_Frame_WithHigh = 0x09410E;
constexpr uint24_t Title_Main_Frame_NoHigh = 0x094120;
constexpr uint24_t Title_Main_Last_Frame_NoFrame = 0x0942AC;
constexpr uint24_t Title_Main_Frame_WithHigh = 0x0942BE;
constexpr uint24_t Title_Main_Last_Frame_WithHigh = 0x09444A;
constexpr uint24_t Title_Main_Game_Frame_NoHigh = 0x09445C;
constexpr uint24_t Title_Main_Game_Frame_WithHigh = 0x094477;
constexpr uint24_t Title_Main_Credits_Frame_NoHigh = 0x094492;
constexpr uint24_t Title_Main_Credits_Frame_WithHigh = 0x0944AD;
constexpr uint24_t Title_Main_High_Frame_WithHigh = 0x0944C8;
constexpr uint24_t Title_Credits_Frame = 0x0944E3;
constexpr uint24_t Title_TimeOut_Frame = 0x09765A;
constexpr uint24_t Title_High_Frame = 0x09A2DC;
constexpr uint24_t Title_IntroGame_1A_Frame = 0x09A363;
constexpr uint24_t Title_CutScene_1_Frame = 0x09A939;
constexpr uint24_t Title_IntroGame_1B_Frame = 0x09DE46;
constexpr uint24_t Title_CutScene_2_Frame = 0x09E41C;
constexpr uint24_t Title_CutScene_3_Frame = 0x09F85C;
constexpr uint24_t Title_CutScene_4_Frame = 0x0A0C9C;
constexpr uint24_t Title_CutScene_5_Frame = 0x0A16BC;
constexpr uint24_t Title_CutScene_6_Frame = 0x0A2C40;
constexpr uint24_t Title_CutScene_7_Frame = 0x0A5709;
constexpr uint24_t Title_CutScene_End_Frame = 0x0A9EF7;
constexpr uint24_t Title_IntroGame_End_Frame = 0x0AB967;
