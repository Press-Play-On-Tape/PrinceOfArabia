...
constexpr uint16_t FX_DATA_PAGE  = 0xfab5;
constexpr uint24_t FX_DATA_BYTES = 346694;
...
constexpr uint24_t Chambers_BG_frame = 0x0549EC;
constexpr uint24_t Chambers_FG_frame = 0x054A3D;
