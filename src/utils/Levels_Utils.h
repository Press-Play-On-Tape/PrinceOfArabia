...
uint24_t Levels_Utils::getLevel_FG(uint8_t levelNo) {
    ...
    uint24_t level_FG[] = { Levels::Level1_FG, Levels::Level2_FG, Levels::Level3_FG, Levels::Level4_FG };
...
uint24_t Levels_Utils::getLevel_BG(uint8_t levelNo) {
    ...
    uint24_t Level_BG[] = { Levels::Level1_BG, Levels::Level2_BG, Levels::Level3_BG, Levels::Level4_BG };
...
uint24_t Levels_Utils::getLevel_Data(uint8_t levelNo) {
    ...
    uint24_t level_Data[] = { Levels::level1_Data, Levels::level2_Data, Levels::level3_Data, Levels::level4_Data };
...
uint24_t Levels_Utils::getLevel_Items(uint8_t levelNo) {
    ...
    uint24_t Level_Items[] = { Levels::Level1_Items, Levels::Level2_Items, Levels::Level3_Items, Levels::Level4_Items };
