...
uint24_t Levels_Utils::getLevel_FG(uint8_t levelNo) {
    ...
    uint24_t level_FG[] = { Levels::Level1_FG, Levels::Level2_FG };
...
uint24_t Levels_Utils::getLevel_BG(uint8_t levelNo) {
    ...
    uint24_t Level_BG[] = { Levels::Level1_BG, Levels::Level2_BG };
...
uint24_t Levels_Utils::getLevel_Data(uint8_t levelNo) {
    ...
    uint24_t level_Data[] = { Levels::level1_Data, Levels::level2_Data };
...
uint24_t Levels_Utils::getLevel_Items(uint8_t levelNo) {
    ...
    uint24_t Level_Items[] = { Levels::Level1_Items, Levels::Level2_Items };
