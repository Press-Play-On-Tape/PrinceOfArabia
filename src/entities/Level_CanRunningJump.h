        ...
        case Action::RunJump_3:
            {
                ...
                if ((distToEdgeOfCurrentTile == 2 || distToEdgeOfCurrentTile == 6) &&
                    ...
                    wallTile6_NextLvl == WallTileResults::SolidWall &&
